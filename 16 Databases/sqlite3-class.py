...
class database:
    ...
    def __init__(self, **kwargs):
        ...
        self.table = kwargs.get('table', 'test') # assign 'test' to self.table --> 'test' to self._tables via @table.setter
    ...
    # fn is test.db >> from __init__ >> self.filename = kwargs.get('filename')
    @filename.setter
    ...
    @property
    def table(self): return self._table # Needed for the table.setter and table.deleter
